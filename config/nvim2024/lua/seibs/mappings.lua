...
KEYMAPS['lsp'] = {
    ...
    n = {
        ...
        ['gD'] = { function() require('telescope.builtin').lsp_references() end, 'LSP Definitions' },
...
KEYMAPS['telescope'] = {
    n = {
        ...
        ['<leader>fe'] = { function() require('telescope.builtin').diagnostics() end, 'Telescope diagnostics' },
...
KEYMAPS['harpoon'] = {
    n = {
        ['<leader>'] = {
            ...
            ['th'] = { function() require('harpoon.ui').toggle_quick_menu() end, 'Toggle Harpoon' },
            ['a'] = { function() require('harpoon.mark').add_file() end, 'Add to Harpoon' },
        }
    }
}
